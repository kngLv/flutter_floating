...
移除 FloatingManager中closeFloating和closeAllFloating方法(破坏性修改)，请使用 getFloating()
.close() 代替

改进 FloatingLog 类方法，提高可读性
...
由于 v0.1.3 版本导致 flutter3.0 以下无法使用，所以，flutter3.0 以下 请使用 v0.1.4，3.0及以上使用
v0.1.3即可
